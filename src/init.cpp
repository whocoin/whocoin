    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Whocoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  whocoind [options]                     " + "\n" +
                  "  whocoind [options] <command> [params]  " + _("Send command to -server or whocoind") + "\n" +
                  "  whocoind [options] help                " + _("List commands") + "\n" +
                  "  whocoind [options] help <command>      " + _("Get help for a command") + "\n";
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -pid=<file>            " + _("Specify pid file (default: whocoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 111964 or testnet: 11965)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 11963 or testnet: 11966)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Whocoin Wiki for SSL setup instructions)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. Whocoin is probably already running."), strDataDir.c_str()));
