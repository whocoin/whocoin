...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Whocoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"whocointools.com", "dnsseed.whocointools.com"},
    {"whocoinpool.org", "dnsseed.whocoinpool.org"},
    {"xurious.com", "dnsseed.who.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"whocointools.com", "testnet-seed.whocointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Whocoin is probably already running."), addrBind.ToString().c_str());
        else
